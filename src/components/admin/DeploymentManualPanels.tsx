    ...
    <Card className="p-6 space-y-6">
      ...
      <div className="space-y-2">
        ...
        <ol className="list-decimal pl-5 text-sm space-y-1">
          ...
          <li>Deploy edge functions (one-time): <code>supabase functions deploy access-submit access-approve admin-code-login admin-data admin-action user-signin</code>.</li>
        </ol>
      </div>
